...
public class OpenApiConfig {
	...
	public GroupedOpenApi publicApi() {
		return GroupedOpenApi.builder()
				...
				.displayName("Twitee API")
				.packagesToScan("org.tm30.security.api")
				.build();
	}
	...
	public OpenAPI myOpenAPI() {
		...
		contact.setName("Authentication API");
		contact.setUrl("https://www.twitee.com");

		License mitLicense = new License().name("MIT License").url("https://choosealicense.com/licenses/mit/");

		Info info = new Info().title("Twitee API").version("1.0").contact(contact)
				.description("This API exposes endpoints to manage tutorials.")
				.termsOfService("https://www.twitee.com/terms").license(mitLicense);
